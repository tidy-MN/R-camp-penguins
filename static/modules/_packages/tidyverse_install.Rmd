...
> Welcome to the **tidyverse**. We can now access ALL of the wonderful functions included in the umbrella of tidyverse packages.


<br>

The 4 core tidyverse packages we'll be using in R camp:
...
#### See the full list of tidyverse packages here: https://www.tidyverse.org/packages/ {-}
