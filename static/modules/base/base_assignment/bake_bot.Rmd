...
<h3> <i class="fas fa-cookie-bite" aria-hidden="true" style="color: gray;"></i> Taste test </h3> {-}

### How can we get our `bot_friend` back? {-}

<details><summary class = "btn_blue">_Show solution_</summary>
...
Use square brackets after the name of your vector (`baking_bots[1]`) to view a specific value in the vector. You can also use the function `pluck()` by giving the function the name of your vector and the index of the value you want to see, like so: `pluck(baking_bots, 1)`.
...
# View the first value in baking bots using the pluck() function
pluck(baking_bots, 1)
```
