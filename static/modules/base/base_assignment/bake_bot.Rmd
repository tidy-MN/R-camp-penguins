...
<div class="tip">
### <i class="fa-solid fa-user-chef" style="color: gray;"></i> Bake it! {-}

How can we get our `bot_friend` back?

_Hint: You can re-run your code anytime. You can even click the **Run** button at the top of the script panel to re-run ALL of your code from top to bottom._
...
Try running some of these examples. Find new ways to create errors. Half of learning R is finding what doesn't work.
...
- Try to create a **new** error or warning.
...
baking_bots <- c("Whiskers", "Baker-waker", "bb8")
...
### <i class="fa-solid fa-cookie-bite" aria-hidden="true" style="color: gray;"></i> Taste test
