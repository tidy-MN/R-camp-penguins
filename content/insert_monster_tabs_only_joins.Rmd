...
<img class="animated infinite bounce" src="../images/monsters/monster_data2.png" style="width: 44%; margin-left: -2px; float: left;">

<img src="../images/monsters/monster_names.png" style="width: 20%; margin-top: 6px; margin-right: 0;">
...
![](../images/monsters/left_join_named_monsters.png){style="width: 98%; margin-top: 12px;"}
...
![](../images/monsters/anti_join_no_name_monsters.png){style="width: 98%; margin-top: 12px;"}
