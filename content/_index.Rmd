...
### <i class="fa fa-video-camera"></i> <span style="font-size: 90%">6.2 - </span> Choose <span class="teal">**[1]**</span> of our favorites from the R community
...
- <i class="fa fa-video-camera teal"></i> <span style="font-size: 90%"> [Regression and Linear Models](https://www.youtube.com/watch?v=j5mu5XcJD_w&list=PLik6fAQnSI93eBVuAONFBCVdOd7VFhKQX&index=8) *(20 min)*
    - [Notes](page/videos/day6/amelia_stat220_regression_prelab.html) or Download the [.Rmd file](https://github.com/tidy-MN/R-camp-penguins/raw/main/content/page/videos/day6/amelia_stat220_regression_prelab.Rmd))
