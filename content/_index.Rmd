...
### <i class="fa fa-video-camera"></i> <span style="font-size: 90%">2.2 - </span> Forks in the road: A case_when 
  
- [Notes and code examples](page/day2.html#forks) 
- Slides
...
- [Date mischief and data joins](page/exercise/day3/03-1-date-mischief-and-data-joins.html)
...
- [ggplot exercises](page/exercise/day4/4-1-ggplot_exercises.html)
