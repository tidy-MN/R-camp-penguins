...
### <i class="fa fa-video-camera"></i> <span style="font-size: 90%">6.2 - </span> [Fancy reports: **Quarto documents**](https://quarto.org/docs/get-started/hello/rstudio.html)

- [Download the Quarto file](https://quarto.org/docs/get-started/hello/rstudio/_hello.qmd) and follow along with the *Get started* video
