...
- [Notes and code examples](page/day4.html#sf-spatial-analysis-part2)
...
### <i class="fa fa-video-camera"></i> <span style="font-size: 90%">6.2 - </span> R markdown: Reports, dashboards, presentations, and web pages  
