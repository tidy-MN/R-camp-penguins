...
### <i class="fas fa-clipboard"></i> <span style="font-size: 90%">0.1 - </span> [Install R](page/install.html)
...
### <i class="fas fa-clipboard"></i> <span style="font-size: 90%">0.2 - </span> [Camp Primer](page/r_camp_primer.html) 
...
- [Notes and code examples](page/day1.html#rstudio-tour) 
...
- [Notes and code examples](page/day1.html#names-and-things) 
...
- [Notes and code examples](page/day1.html#tidy-tables-and-dataframes) 
...
- [Notes and code examples](page/day1.html#size-up-the-data) 
- [Slides](https://tidy-mn.github.io/R-camp-slides/day1/01-4-Tables-and-dataframes#1)

### <i class="fa fa-birthday-cake" aria-hidden="true"></i> Exercises

- [Taking inventory](page/exercise/day1/inventory_duty.html)
- [Auditor in training](page/exercise/day1/inventory_duty_expanded.html)
...
### <i class="fa fa-video-camera"></i> <span style="font-size: 90%">2.2 - </span> [Fork in the road: `if_else` + `case_when`](page/videos/day2/02-2-fork-in-the-road)
...
- [Notes and code examples](page/day2.html#summarize) 
- [Slides](https://tidy-mn.github.io/R-camp-slides/day2/02-3-Boil-it-down.html#1)


### <i class="fa fa-birthday-cake" aria-hidden="true"></i> Exercises

- [Describe penguin populations](page/exercise/describe_penguin_populations.html)
- [Guess Who! *Hint: I'm a penguin*](page/exercise/find_the_penguin.html)
...
- [ggplot exercises](page/exercise/day3/3-1-ggplot_exercises.html)
...
- 5.1: [Spatial awareness and GIS](page/exercise/day5/intro_to_gis.html)
- 5.2: [sf: Simple features package](page/exercise/day5/sf.html)
- [Points, Lines, and Polygons](page/exercise/day5/5_3_points_lines_polygons.html)
