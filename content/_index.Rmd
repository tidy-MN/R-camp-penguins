...
### <i class="fa fa-video-camera"></i> <span style="font-size: 90%">3.2 - </span> ggplot: Facets, colors, and labels
...
- [Exercise 2 - ggplot](page/exercise/day3/3-2-ggplot_exercises.html)
...
### <i class="fa fa-video-camera"></i> <span style="font-size: 90%">4.1 - </span> Intro to Maps

### <i class="fa fa-video-camera"></i> <span style="font-size: 90%">4.2 - </span> Welcome to `sf`


### <i class="fa fa-birthday-cake" aria-hidden="true"></i> Exercise Day

- [Homeward bound](page/exercise/day4/4-homeward-bound.html)
...
- [Date mischief and data joins](page/exercise/day5/05-1-date-mischief-and-data-joins.html)
