...
### <i class="fa fa-video-camera"></i> <span style="font-size: 90%">6.1 - </span> [Pivoting data: Wide <-> Long format](page/videos/day6/06-1-lubridate-date-and-time-travel.html)

- [Slides](https://tidy-mn.github.io/R-camp-slides/day6/06-1-pivot-wider.html#1)


**Choose [1] of the videos below (from other R friends)** 
