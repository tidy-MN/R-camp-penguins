...
<!-- Dorian's thoughts: -->
<!-- Some other big hang-ups for newbie folks are their lack of computer navigation skills. Such as: How do I find the path to my files? Where's my download/documents folder? What is a directory anyways? Why doesn't R automatically know how to find the "data.csv" file I put in a random spot on a shared drive?  -->

<!--
Anton's thoughts:
ask barbara about a breakout room for people having installation issues
after they run code, ask question related to what they found
-->

# Introduction

This workshop is designed for people entirely new to R. It will take you through the basics of navigating RStudio and using R. You will learn the following content:
...
<!-- video of this or just webpage? -->

State employees install R and RStudio in the order below from the MNIT Software Center. Install R first, then RStudio. RTools is optional for advanced R users.

```{r, out.width = "50%", fig.cap = "List of software", echo = FALSE, fig.alt = "Screenshot of MDH software Center list of R software"}
knitr::include_graphics("../images/Software_to_install.png")
```



Everyone else will need to install from multiple websites.
...
After you have installed R, you can install RStudio. RStudio is a wrapper that makes R more user-friendly and adds functionality, such as support for Markdown and dedicated tabs for environments, tables, and images. 
...
# purpose: to practice R code in the MDH R prequel workshop
```
