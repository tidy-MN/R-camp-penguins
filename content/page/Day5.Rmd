...
# <i class="fa fa-video-camera"></i> <span style="font-size: 90%"> [Dataframe SMASH: **Joining tables**](videos/day5/05-1-smash-table-joins.Rmd)
...
# <i class="fa fa-video-camera"></i> <span style="font-size: 90%"> [**lubridate:** Date and time travel](videos/day5/05-2-lubridate-date-and-time-travel)
