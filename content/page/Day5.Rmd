...
<img src="https://raw.githubusercontent.com/gadenbuie/tidyexplain/main/images/left-join.gif" style="width: 75%; margin-top: 2px;">
...
```{r, eval=F}
anti_join(left_table, right_table,
          by = "shared_column")
```


<img src="https://raw.githubusercontent.com/gadenbuie/tidyexplain/main/images/anti-join.gif" style="width: 75%; margin-top: 2px;">


```{r monster-tabs, results='asis', echo=F, eval=T}
...
<img class="animated fadeInLeft" src="../images/lubridate_bttf_allison_horst.png" style="width: 78%; margin-top: -70px; margin-bottom: -4px;">
