...
To create a more customized table, we will use the package `kableExtra`, which adds many customization options for the `kable()` function. To learn more about `kableExtra`, visit the [kableExtra Cookbook](https://sharlagelfand.github.io/kableExtra-cookbook/). 
...
# Making your report reproducible
...
Then I could rerun my chart like this. Notice how the length of the vector of colors changes depending on the number of demographics I include. This way, I can use the same code whether I want to show males and females side by side or all students combined.
...
legend("topleft", legend = genders_set, fill = my_colors)
```
...
1. Headers for report parts.
1. An introduction to your report. 
1. A link to learn more about your data.
1. A visible code block.
1. At least one chart and at least one table.
1. Captions and alt text that match your chart and table.
1. At least one example of inline R code.
...
Return to [Markdown Crash Course Part 1](markdown_crash_course.html).
