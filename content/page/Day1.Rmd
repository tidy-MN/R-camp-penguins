...
# <i class="fa fa-video-camera"></i> <span style="font-size: 90%"> [Welcome to open source](page/videos/day1/01-1-welcome.html) 
...
# <i class="fa fa-video-camera"></i> <span style="font-size: 90%"> [R tour](page/videos/day1/01-2-r-tour.html) 
...
# <i class="fa fa-video-camera"></i> <span style="font-size: 90%"> [R bakery](page/videos/day1/01-3-r-bakery.html)
...
#  <i class="fa fa-video-camera"></i> <span style="font-size: 90%"> [Tidy tables](page/videos/day1/01-4-tidy-tables.html)
...
# <i class="fa fa-video-camera"></i> <span style="font-size: 90%"> [Sizing up the data](page/videos/day1/01-5-size-up-the-data.html)
