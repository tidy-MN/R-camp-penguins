...
<style> 
code {color: cornflowerblue !important;} 
...
__RStudio__ is the handy user interface we use to write R scripts and keep our projects organized. It isn't required to use R, but it makes thin a whole lot easier.
...
State employees at MDH and other Agencies can follow these steps:

__Install RStudio and R__  

<div class="well" style="margin-top: 4px;">
1. Open the Software Center
2. Search for RStudio
3. Choose the blue R bubble
  - If it doesn't appear, submit a service ticket to your local MNIT friends
4. Click `[ Install ]`
...
## Outside folks and friends {-}

For those with enough permissions to install software on their computers, R and RStudio may be downloaded and installed for free from the following sites:
...
As a stop gap until you're able to install R locally, you can create an account at the link below and use R in browser for the training.
...
>
> The sections below are only for reference, and they do not need to be completed before R camp begins.
>
