...
> [**ggplot cheatsheet**](https://rstudio.github.io/cheatsheets/data-visualization.pdf) - View more examples and the aesthetics used in each geom




# <i class="fa fa-video-camera"></i> <span style="font-size: 90%"> [ggplot: Facets, colors, and labels](page/videos/day3/03-2-ggplot-facets-colors-labels.html)
