...
```{r child = '../../static/modules/dplyr/dplyr_toolbox/starter.Rmd'}
```
...
# Video 2.2: <span class="bluecode">`Fork in the road: if_else() and case_when()`</span> 
...
# Video 2.3: <span class="bluecode">`Boil it down // Summarize the data`</span>
