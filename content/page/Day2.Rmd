...
# <i class="fa fa-video-camera"></i> <span style="font-size: 90%"> [Data wrangling](page/videos/day2/02-1-data-wrangling.html)
...
# <i class="fa fa-video-camera"></i> <span style="font-size: 90%"> [Fork in the road: `if_else` + `case_when`](page/videos/day2/02-2-fork-in-the-road)
