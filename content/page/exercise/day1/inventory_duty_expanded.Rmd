...
- Summary statistics are calculated for both dry and liquid measures 
  - *(Don't mix and match! Fluid ounces are different from dry ounces and gosh wouldn't it be swell if everything was metric...)*
...
```{r}
# unique only likes vectors, so use the $ (dollar sign) 
# to pull out an individual column from the dataframe
...
show_hint = 'code_start
filter(audit_df, SOMETHING_IS >= 10) # Try doing some math in the filter function!
code_end',
