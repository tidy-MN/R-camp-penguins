...
filter(audit_df, is.na()) #What goes inside is.na and what does is.na do?
code_end',
...
```{r}
unique(audit_df$CATEGORY) #unique only likes vectors, so use the dollar sign to pull out the individual column from the dataframe!
```
