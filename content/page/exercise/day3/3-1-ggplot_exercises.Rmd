...
# This loads the penguins data from the palmerpenguins package
penguins <- penguins
```
...
Excellent! So body mass and flipper length are VERY correlated and flipper length and bill length and depth also seem to be related. Honestly a lot of these seem related, so let's go for the MOST correlated pair. *And remember to include species in the `aes()` to show the correlations for specific species.
