...
We'll first set up 2 points and then calculate how far apart they are. Next we will develop a polygon that is a straight path between these two nesting locations and join it with any overlapping states to get a list of states that the bird will fly through. The we will make some maps of the migration path. *As an additional piece of homework, we'll leave it to you to develop strict conservation laws to protect the trees in along this flight path.*
