...
### <i class="fa fa-video-camera" ></i> <span style="font-size: 90%">1.4 - </span> [Tidy tables](videos/day1/01-4-tidy-tables.Rmd)
...
### <i class="fa fa-video-camera" ></i> <span style="font-size: 90%">1.4 - </span> [Sizing up the data](videos/day1/01-5-size-up-the-data.Rmd)
