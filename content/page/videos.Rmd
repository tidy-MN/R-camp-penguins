...
add_tabs(paste("Day", 1:6), c('### <i class="fa fa-video-camera" ></i> [1.1 Welcome to open source](videos/01-1-welcome.html)
...
- <i class="far fa-comment-alt" ></i> [**Notes and code**](Day1_AM.html#names-and-things) 
- [**Slides**](https://mn-r-slides.netlify.app/day1/01-3-Our-crew.html)', rep("", 5)))
