...
<li class="nav-item">
<a class="nav-link" id="mutate-tab" data-toggle="tab" href="#mutate" role="tab" aria-controls="mutate" aria-selected="false"> `mutate`</a>
</li>
<li class="nav-item">
...
<li class="nav-item">
<a class="nav-link" id="groupby-tab" data-toggle="tab" href="#groupby" role="tab" aria-controls="groupby" aria-selected="false"> `groupby`</a>
</li>
<li class="nav-item">
...
<div class="tab-pane fade" id="mutate" role="tabpanel" aria-labelledby="mutate-tab">
...
<div class="tab-pane fade" id="groupby" role="tabpanel" aria-labelledby="groupby-tab">
