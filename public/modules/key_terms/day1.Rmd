...
|           |  |                                                                  |   
|-----------|--|:-----------------------------------------------------------------|  
|`object  `|  | A variable in R that we can assign different values to using the assignment operator.  | 
|`<-  `|  | The assignment operator can assign a value to a new object or update an existing object.  | 
